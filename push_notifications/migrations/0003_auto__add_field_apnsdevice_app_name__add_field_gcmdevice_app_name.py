...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevice.app_name'
        db.add_column(u'push_notifications_apnsdevice', 'app_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevice.app_name'
        db.add_column(u'push_notifications_gcmdevice', 'app_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevice.app_name'
        db.delete_column(u'push_notifications_apnsdevice', 'app_name')

        # Deleting field 'GCMDevice.app_name'
        db.delete_column(u'push_notifications_gcmdevice', 'app_name')
    ...
    models = {
        ...
        u'push_notifications.apnsdevice': {
            ...
            'app_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
